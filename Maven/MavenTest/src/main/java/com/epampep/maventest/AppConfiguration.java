...
@Configuration
@ComponentScan({ "com.epampep.maventest" })
    ...
    public ServletContextInitializer initializer()
    {
        return new ServletContextInitializer()
        {
            ...
            public void onStartup(ServletContext servletContext) throws ServletException {
                servletContext.setInitParameter("tapestry.app-package", "com.epampep.maventest");
                servletContext.setInitParameter("tapestry.development-modules", "com.epampep.maventest.services.DevelopmentModule");
